...
用法:
  get_link.py [--repo]                仓库主页（默认）
  get_link.py --issues                Issues 页面
  get_link.py --actions               Actions 页面
  get_link.py --compare <tag>         单 tag 比较链接（初始版本）: compare/<tag>
  get_link.py --compare <old> <new>   双 tag 比较链接: compare/<old>...<new>
  get_link.py --dir <path>            gitrepo.toml 所在目录（默认当前目录）
"""
